...
const Placement = () => {
  ...
  return (
    <div>
      ...
      <div className=" lg:flex py-4 justify-center gap-x-4 hidden ">
        <div className="card ">
          ...
          <div className="dateinfo">
            <p className=" text-[14px] text-white  font-inter  ">October 7,2022</p>
          </div>{" "}
        </div>
        <div className="flex flex-col gap-y-5">
          <div className="flex flex-row gap-x-5">
            <div className="card1 ">
              ...
              <div className="dateinfo">
                <p className=" text-[10px] text-white   font-inter ">October 7,2022</p>
              </div>
            </div>
            <div className="card1 ">
      ...
      <div className="lg:flex hidden justify-end px-36 py-3 pb-7">
